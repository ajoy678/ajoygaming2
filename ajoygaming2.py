...
.----------------. .----------------. .----------------. .----------------. | .--------------. || .--------------. || .--------------. || .--------------. | | | __ | || | _____ | || | ____ | || | ____ ____ | | | | / \ | || | |_ _| | || | .' `. | || | |_ _||_ _| | | | | / /\ \ | || | | | | || | / .--. \ | || | \ \ / / | | | | / ____ \ | || | _ | | | || | | | | | | || | \ \/ / | | | | _/ / \ \_ | || | | |_' | | || | \ `--' / | || | _| |_ | | | ||____| |____|| || | `.___.' | || | `.____.' | || | |______| | | | | | || | | || | | || | | | | '--------------' || '--------------' || '--------------' || '--------------' | '----------------' '----------------' '----------------' '----------------' 
...
\x1b[1;96m┏─══─━══─══━─══─| ✠ |─══━─══─══━─══─┓
\x1b[38;5;46m┃AUTHOR    ;  BY ASIF            ┃
\x1b[1;93m┃WHATSAPP  ; +8801747130005         ┃
\x1b[1;95m┃FACEBOOK  ; Md Robin          ┃
\x1b[1;91m┃GITHUB    ; TAYBUL BY ASIF Cyber_101┃
\x1b[1;96m┗─══─━════─━─══─| ✠ |─══━─══─══━─══─┛
...
\x1b[1;96m┏─══─━══─══━─══─| ✠ |─══━─══─══━─══─┓
\x1b[38;5;46m┃AUTHOR    ; TAYBUL BY ASIF            ┃
\x1b[1;93m┃WHATSAPP  ; +8801747130005         ┃
\x1b[1;95m┃FACEBOOK  ; Md Robin                     ┃
\x1b[1;91m┃GITHUB    ; TAYBUL BY ASIF Cyber_101┃
\x1b[1;96m┗─══─━════─━─══─| ✠ |─══━─══─══━─══─┛
...
def fuck():
    ...
    os.system('clear')
    os.system('xdg-open https://youtube.com/@officialringtone53183')
    print(logo)
